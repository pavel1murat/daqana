...
// body of the init function - shared
   ...
   // fChain->SetBranchAddress("sd._ns", &sd__ns, &b_sd__ns);
   ...
   // fChain->SetBranchAddress("sh.dped", sh_dped, &b_sh_dped);
   // fChain->SetBranchAddress("sh.dpmp", sh_dpmp, &b_sh_dpmp);
   ...
   // fChain->SetBranchAddress("tc.ngh", tc_ngh, &b_tc_ngh);
   ...
   // fChain->SetBranchAddress("ncrvd", &ncrvd, &b_evt_ncrvd);
   // fChain->SetBranchAddress("crvd", &crvd_, &b_evt_crvd_);
   // fChain->SetBranchAddress("crvd.fUniqueID", &crvd_fUniqueID, &b_crvd_fUniqueID);
   // fChain->SetBranchAddress("crvd.fBits", &crvd_fBits, &b_crvd_fBits);
   // fChain->SetBranchAddress("crvd.sbid", &crvd_sbid, &b_crvd_sbid);
   // fChain->SetBranchAddress("crvd.tdc", &crvd_tdc, &b_crvd_tdc);
   // fChain->SetBranchAddress("crvd.nzs", &crvd_nzs, &b_crvd_nzs);
   // fChain->SetBranchAddress("crvd.odd_ts", &crvd_odd_ts, &b_crvd_odd_ts);
   // fChain->SetBranchAddress("crvd.sipm", &crvd_sipm, &b_crvd_sipm);
   // fChain->SetBranchAddress("crvd.roc", &crvd_roc, &b_crvd_roc);
   // fChain->SetBranchAddress("crvd.feb", &crvd_feb, &b_crvd_feb);
   // fChain->SetBranchAddress("crvd.ch", &crvd_ch, &b_crvd_ch);
   // fChain->SetBranchAddress("ncrvp", &ncrvp, &b_evt_ncrvp);
   // fChain->SetBranchAddress("crvp", &crvp_, &b_evt_crvp_);
   // fChain->SetBranchAddress("crvp.fUniqueID", &crvp_fUniqueID, &b_crvp_fUniqueID);
   // fChain->SetBranchAddress("crvp.fBits", &crvp_fBits, &b_crvp_fBits);
   // fChain->SetBranchAddress("crvp.npes", &crvp_npes, &b_crvp_npes);
   // fChain->SetBranchAddress("crvp.pes_ph", &crvp_pes_ph, &b_crvp_pes_ph);
   // fChain->SetBranchAddress("crvp.time", &crvp_time, &b_crvp_time);
   // fChain->SetBranchAddress("crvp.ph", &crvp_ph, &b_crvp_ph);
   // fChain->SetBranchAddress("crvp.ped", &crvp_ped, &b_crvp_ped);
   // fChain->SetBranchAddress("crvp.beta", &crvp_beta, &b_crvp_beta);
   // fChain->SetBranchAddress("crvp.chi2", &crvp_chi2, &b_crvp_chi2);
   // fChain->SetBranchAddress("crvp.le_time", &crvp_le_time, &b_crvp_le_time);
   // fChain->SetBranchAddress("crvp.flags", &crvp_flags, &b_crvp_flags);
   // fChain->SetBranchAddress("crvp.npes_nofit", &crvp_npes_nofit, &b_crvp_npes_nofit);
   // fChain->SetBranchAddress("crvp.time_nofit", &crvp_time_nofit, &b_crvp_time_nofit);
   // fChain->SetBranchAddress("crvp.tstart", &crvp_tstart, &b_crvp_tstart);
   // fChain->SetBranchAddress("crvp.tend", &crvp_tend, &b_crvp_tend);
   // fChain->SetBranchAddress("crvp.sbid", &crvp_sbid, &b_crvp_sbid);
   // fChain->SetBranchAddress("crvp.sipm", &crvp_sipm, &b_crvp_sipm);
   // fChain->SetBranchAddress("crvp.roc", &crvp_roc, &b_crvp_roc);
   // fChain->SetBranchAddress("crvp.feb", &crvp_feb, &b_crvp_feb);
   // fChain->SetBranchAddress("crvp.ch", &crvp_ch, &b_crvp_ch);
   // fChain->SetBranchAddress("ncrvc", &ncrvc, &b_evt_ncrvc);
   // fChain->SetBranchAddress("crvc", &crvc_, &b_evt_crvc_);
   // fChain->SetBranchAddress("crvc.fUniqueID", &crvc_fUniqueID, &b_crvc_fUniqueID);
   // fChain->SetBranchAddress("crvc.fBits", &crvc_fBits, &b_crvc_fBits);
   // fChain->SetBranchAddress("crvc.stype", &crvc_stype, &b_crvc_stype);
   // fChain->SetBranchAddress("crvc.tstart", &crvc_tstart, &b_crvc_tstart);
   // fChain->SetBranchAddress("crvc.tend", &crvc_tend, &b_crvc_tend);
   // fChain->SetBranchAddress("crvc.pes", &crvc_pes, &b_crvc_pes);
   // fChain->SetBranchAddress("crvc.time", &crvc_time, &b_crvc_time);
   // fChain->SetBranchAddress("crvc.x", &crvc_x, &b_crvc_x);
   // fChain->SetBranchAddress("crvc.y", &crvc_y, &b_crvc_y);
   // fChain->SetBranchAddress("crvc.z", &crvc_z, &b_crvc_z);
   // fChain->SetBranchAddress("crvc.nlayers", &crvc_nlayers, &b_crvc_nlayers);
   // fChain->SetBranchAddress("crvc.nsides", &crvc_nsides, &b_crvc_nsides);
