#ifndef __daqana_ana_plot_sh_hh__
#define __daqana_ana_plot_sh_hh__
...
//-----------------------------------------------------------------------------
  ...
  plot_sh(int RunNumber, const char* Fn = nullptr, const char* Label="n001");
  ...
  int              FillChannelHistograms(ChannelHist_t* Hist, Index_t* Index, DaqStrawHit* Sh);
  int              FillPanelHistograms  (PanelHist_t*   Hist, Index_t* Index, DaqStrawHit* Sh);
  int              FillSlotHistograms   (SlotHist_t*    Hist, Index_t* Index, DaqStrawHit* Sh);
  int              FillHistograms       ();
